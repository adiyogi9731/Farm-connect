	 ...
	 <div class="row text-center" >
		...
		<table class = "table table-bordered">
				...
				if(isset($_SESSION['username'])){
					...
					$sql =	"SELECT order.orderid,order.category, order.quantity, order.price, order.status FROM `order`, `products` WHERE 
			order.Buyer = '$username' AND order.orderid =  '$productid' AND order.status = 'DELIVERED'  ";
